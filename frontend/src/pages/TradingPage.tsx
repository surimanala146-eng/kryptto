...
export function TradingPage() {
  ...
  // Focus server-aggregated candle streaming on the active chart
  // (kryptto backend mode; no-op for the in-browser demo layer).
  useEffect(() => {
    wsClient.setChartStream(selectedSymbol, timeframe);
